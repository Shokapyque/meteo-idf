            ...
            <div className="row">
                ...
                <div className="card">
                    <div className="card1">
                        ...
                        <div className="footer-button-container">
                            <Link href="/paris" className="footer-button"> Voir la météo de Paris</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="card">
                    <div className="card1">
                        ...
                        <div className="footer-button-container">
                            <Link href="/New-York" className="footer-button"> Voir la météo de New York</Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="card">
                    <div className="card1">
                        ...
                        <div className="footer-button-container">
                            <Link href="/Tokyo" className="footer-button"> Voir la météo de Tokyo</Link>
                        </div>
                    </div>
                </div>
